    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col mb-4">
        ...
        <select
          ...
          onChange={(e) => dispatch({ type: ACTION.SET_CATEGORY, payload: e.target.value })}
        >
      ...
      <div className="flex flex-col mb-4">
        ...
        <select
          ...
          className="border p-2 rounded-lg"
          value={state.country}
          onChange={(e) => dispatch({ type: ACTION.SET_COUNTRY, payload: e.target.value })}
        >
      ...
      <div className="flex flex-col mb-4">
        ...
        <input
          ...
          className="border p-2 rounded-lg"
          value={state.price}
          onChange={(e) => dispatch({ type: ACTION.SET_PRICE, payload: e.target.value })}
        />
      </div>
      <div className="flex flex-col mb-4">
        ...
        <input
          ...
          className="border p-2 rounded-lg"
          value={state.title}
          onChange={(e) => dispatch({ type: ACTION.SET_TITLE, payload: e.target.value })}
        />
      </div>
      ...
      <div className="flex justify-center mt-8">
        <button
          ...
          onClick={() => console.log('Submit form')} // Add your submission logic here
        >
          Create Listing
        </button>
      </div>
